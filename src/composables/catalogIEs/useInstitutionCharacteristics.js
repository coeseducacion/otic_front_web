...
export const useInstitutionCharacteristics = () => {
  ...
  const getInstitutionCharacteristics = async (params={},rowsPerPage=15,toPage=1) => {
    ...
    //   console.log('Response modules:', response)
      ...
      console.error('Error al obtener características de institución:', err)
      // ✅ Notificación de error
      notify.error(err.response?.data?.message || 'Error al obtener características de institución', 4000)
